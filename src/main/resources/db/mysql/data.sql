...
INSERT INTO clients (id, name, email, address, parking, municipio, init, finish, telephone, description, food, expiration, pregunta_segura1, pregunta_segura2, username) VALUES (1,'Bar manoli','manoli@gmail.com','C/Betis', TRUE,'Sevilla','10:00:00','22:00:00','608726190', 'Bar Manoli, ¡tu bar favorito!', 'española', '2029-08-15' ,'manoli','manoli','manoli');
INSERT INTO clients (id, name, email, address, parking, municipio, init, finish, telephone, description, food, expiration, pregunta_segura1, pregunta_segura2, username) VALUES (2,'Bar david','david@gmail.com', 'C/Sevilla', FALSE, 'Dos_Hermanas','09:30:00','22:00:00','608726190', 'Food from USA', 'americana', '2029-08-15','david', 'david', 'david');
